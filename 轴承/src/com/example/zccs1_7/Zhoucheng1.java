...
public class Zhoucheng1 extends Activity {
...
//        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);//强制为横屏  
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.zhoucheng1, menu);
        return true;
    }
...
private void findView() {
	...
	//获得图片
	bitmap = ((BitmapDrawable)getResources().getDrawable(R.drawable.qianzhidaima)).getBitmap();
}
