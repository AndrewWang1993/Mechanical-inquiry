...
public class Xiechilun extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.xiechilun);
		...
		button21.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
                ...
                float bs=Float.parseFloat(editText1.getText().toString());
				
				float a = (float) (ms * cs/Math.cos(bs/180*Math.PI)), 
						b = ms, 
						c = (float) (1.25 * ms),
						d = (float) (2.25 * ms),
						e = a+b,
						f = a -c,
						g = (float) (ms * cs * Math.sin(90 / cs / 180 * Math.PI)),
						h = (float) (ms + ms* cs / 2 * (1 - Math.cos(90 / cs / 180 * Math.PI)));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.xiechilun, menu);
		return true;
	}
